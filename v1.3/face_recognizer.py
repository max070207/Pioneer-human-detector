                    ...
                    try:
                        ...
                        for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
                            ...
                            if person_name != "Unknown":
                                ...
                                if face_save_count[person_name] == 1:
...
class FaceRecognizer:
    ...
    def _draw_multiple_faces_message_pil(self, frame, known_faces):
        """Отрисовка информации о нескольких распознанных лицах через PIL"""
        frame_rgb = cv2.cvtColor(frame, cv2.COLOR_BGR2RGB)
        pil_img = Image.fromarray(frame_rgb)
        draw = ImageDraw.Draw(pil_img, 'RGBA')
        try:
            font = ImageFont.truetype("calibrib.ttf", 24)
        except:
        ...
        try:
            ...
            main_height = main_bbox[3] - main_bbox[0]
            max_name_width = 0
            total_height = main_height + 20
            for i, (person_name, location, similarity) in enumerate(known_faces):
                ...
                face_height = face_bbox[3] - face_bbox[0]
        ...
        padding = 15
        rect_x1 = 0
        rect_y1 = frame_height - text_height - padding + 10
        rect_x2 = rect_x1 + max_width + 2 * padding - 10
