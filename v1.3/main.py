...
class HumanDetector:
    ...
    def add_info_text(self, frame, human_detected):
        ...
        draw.text((x1 + 10, y1 + 10), status_text, font=font, fill=text_color)
        draw.text((x1 + 10, y1 + 35), f"FPS: {self.fps}", font=font, fill=(224, 255, 255))
        ...
        draw.text((x1 + 10, y1 + 60), search_status, font=font, fill=search_color)
